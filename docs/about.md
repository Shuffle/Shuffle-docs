...
## Open Source
After a long time of no activity, I decided to open source Shuffle. The cloud version is still intact, but focus will move away from it for a while. 

More in the blogposts below.
