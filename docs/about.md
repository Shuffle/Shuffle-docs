...
* **In Development:**  API Standardization & Security Infrastructure as a Service: **Schemaless**, Focus on Usecase generation, Technology Partnerships, Developer Friendliness, Mitre D3FEND and Att&ck, Sigma, Sublime emails. OASIS OpenC2 & CACAO support. Documentation -> Apps AI + API action merging from forks. Auth Proxy tests and Multi-Tenant Workflows. Expected release: November-December 2024.
* After next release: Creator & Community earning re-initialization. Focus on App, Workflow, Detection and Response ruleset sharing. Add Yara+Sandbox autoscans, Ansible response playbooks and OSQuery asset mapping. Expansive Mitre Att&ck & D3FEND support. Support for JSON-schema & Postman Collections
